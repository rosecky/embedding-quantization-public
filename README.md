...
| Qwen3-Embedding-0.6B Q5_K_M + q4_0 token table, generic-EN (385 MiB, `llama-quantize`) | Qwen/Qwen3-Embedding-0.6B (Apache-2.0) | same as above | released: 99.8 / 100.1 / 100.1 / 100.1 % on SciFact / NFCorpus / ArguAna / SciDocs, cosine 0.988–0.992 (+0.3 points, +0.01 cosine over Q4_K_M; below our own threshold, published on request) |
