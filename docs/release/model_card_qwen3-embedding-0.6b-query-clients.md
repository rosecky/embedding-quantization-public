...
the importance-matrix text and in the bit width of the blocks (Q4_K_M 4.5 bits, Q5_K_M 5.7 bits). If your corpus is
Czech, take the second, or the third for a closer match to the fp32 ranking; otherwise the first.
...
| corpus (queries) | fp32 | Q4_K_M + q4_0 table, English imatrix | Q4_K_M + q4_0 table, Czech imatrix | Q5_K_M + q4_0 table, Czech imatrix |
|---|---|---|---|---|
